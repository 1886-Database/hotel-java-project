...
public class Form_RoomReservation extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        ROOMIMG= new JPanel() {
        	Image background = new ImageIcon(getClass().getResource("/DB2023188606_view/icon/더블-슈페리어룸(시티뷰)3.jpg")).getImage();
        ...
        RButton.addMouseListener(new MouseAdapter(){
        	public void mouseClicked(MouseEvent e) {
    			...
    			if(ans==JOptionPane.YES_OPTION) {
    				if(num==0) {
	    				rsM.reservation(memberID,roomno,checkin,checkout,reserveddate,requirement,Breakfast,reservedstatus,guestno);
