...
public class Form_AdMyPage extends JPanel {
    ...
    public void initComponents(Employee emp) {
    	...
    	leftPanel_userImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DB2023188606_view/icon/admin.png")));
    ...
    private DB2023188606_modelManager.EmployeeManager employeeManager;
