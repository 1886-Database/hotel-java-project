...
public class RoomManager {
	...
	//객실 관리 화면 Form_AdRoom의 all()에서 호출 : room 테이블의 모든 레코드를 각각 room 객체에 저장한 후 객체 배열 반환
	...
	//예약 화면 Form_Reservation의 getRefreshRoom()에서 호출 : 매개변수 기준으로 필터링된 room 테이블의 레코드 반환
