...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        //호텔INFO 부분
        INFOIMG= new JPanel() {
        	Image background = new ImageIcon(getClass().getResource("/com/raven/icon/호텔썸네일.jpg")).getImage();
        ...
        JPanel RSIMG = new JPanel() {
        	Image background = new ImageIcon(getClass().getResource("/com/raven/icon/조식.png")).getImage();
        	public void paint(Graphics g) {
        		g.drawImage(background, 0, 0, null);
        	}
        };
        	...
        	panelBorder1Layout.createParallelGroup(Alignment.TRAILING)
        		.addGroup(panelBorder1Layout.createSequentialGroup()
        			...
        			.addGroup(panelBorder1Layout.createParallelGroup(Alignment.TRAILING)
        				.addComponent(RSLabel_1, GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)
        				.addComponent(RSIMG, GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		...
        		.addGroup(layout.createSequentialGroup()
        			.addContainerGap()
        			.addComponent(panelBorder1, GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE))
        );
